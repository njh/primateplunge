...
Mix_Chunk* parachuteSnd=NULL;
Mix_Chunk* timeUp=NULL;
Mix_Chunk* congrats=NULL;
Mix_Chunk* congratsEnding=NULL;
Mix_Chunk* getStarRating=NULL;
Mix_Chunk* interface=NULL;
Mix_Chunk* powerupBeanSnd=NULL;
Mix_Chunk* powerupHealthSnd=NULL;
...
SDL_Surface* healthBarFull=NULL;
SDL_Surface* healthBarEmpty=NULL;
SDL_Surface* worldUnlocked=NULL;
...
SDL_Surface* newGameOverImg=NULL;
SDL_Surface* optionsImg=NULL;
SDL_Surface* optionsOverImg=NULL;
SDL_Surface* instructionsImg=NULL;
SDL_Surface* instructionsOverImg=NULL;
SDL_Surface* quitImg=NULL;
SDL_Surface* quitOverImg=NULL;
SDL_Surface* resetImg=NULL;
SDL_Surface* resetOverImg=NULL;
SDL_Surface* backImg=NULL;
SDL_Surface* backOverImg=NULL;
SDL_Surface* yesImg=NULL;
SDL_Surface* yesOverImg=NULL;
SDL_Surface* cancelImg=NULL;
SDL_Surface* cancelOverImg=NULL;
SDL_Surface* sureImg=NULL;
SDL_Surface* soundImg=NULL;
SDL_Surface* soundOverImg=NULL;
SDL_Surface* musicImg=NULL;
SDL_Surface* musicOverImg=NULL;
SDL_Surface* onImg=NULL;
SDL_Surface* offImg=NULL;

SDL_Surface* loadingImg=NULL;
SDL_Surface* instructions=NULL;
SDL_Surface* instructions2=NULL;

SDL_Surface* gameCompleteScreen=NULL;
SDL_Surface* starRating1Screen=NULL;
SDL_Surface* starRating2Screen=NULL;
SDL_Surface* starRating3Screen=NULL;
SDL_Surface* starRating4Screen=NULL;
SDL_Surface* starRating5Screen=NULL;

SDL_Surface* prevArrowImg=NULL;
SDL_Surface* nextArrowImg=NULL;
SDL_Surface* backtoMainImg=NULL;
SDL_Surface* lockedImg=NULL;
SDL_Surface* recordImg=NULL;
SDL_Surface* needImg=NULL;
SDL_Surface* needCompleteImg=NULL;
