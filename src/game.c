...
/* Frame graphic */
currentWorld->frameGraphic = loadGraphic("jungleJitters/frame.bmp");
...
currentWorld->ambientSnd = loadSound("AmbienceJungle.wav");


/* BACKGROUND LAYER 2: */
currentWorld->backgrounds[2] = loadGraphic("jungleJitters/background.bmp");
currentWorld->scrollSpeeds[2] = 2;


/* BACKGROUND LAYER 3: */
currentWorld->backgrounds[3] = loadGraphic("jungleJitters/backTrees.bmp");
currentWorld->scrollSpeeds[3] = 3;


/* BACKGROUND LAYER 4: */
currentWorld->backgrounds[4] = loadGraphic("jungleJitters/vines.bmp");
currentWorld->scrollSpeeds[4] = 4;


/* BACKGROUND LAYER 5: */
currentWorld->backgrounds[5] = loadGraphic("jungleJitters/sideTrunks.bmp");
currentWorld->scrollSpeeds[5] = 5;


/* PLATFORM TYPE 1: */
/* Create new */
currentWorld->platformRefs[nextPlatformRef] = (worldPlatformRef*) malloc(sizeof(worldPlatformRef));
...
/* Frame graphic */
currentWorld->frameGraphic = loadGraphic("crumbleCanyon/frame.bmp");
...
/* Ambient sound effect loop */
currentWorld->ambientSnd = loadSound("AmbienceWind.wav");


/* BACKGROUND LAYER 0: */
currentWorld->backgrounds[0] = loadGraphic("crumbleCanyon/largeBackground.bmp");
currentWorld->scrollSpeeds[0] = 0;


/* BACKGROUND LAYER 4: */
currentWorld->backgrounds[4] = loadGraphic("crumbleCanyon/medRocks.bmp");
currentWorld->scrollSpeeds[4] = 4;


/* BACKGROUND LAYER 5: */
currentWorld->backgrounds[5] = loadGraphic("crumbleCanyon/nearRocks.bmp");
currentWorld->scrollSpeeds[5] = 5;
...
/* Load animation */
loadAnimation("moltenMayhem/normal.bmp", 2, &currentWorld->platformRefs[nextPlatformRef]->anim);
...
/* Load animation */
loadAnimation("moltenMayhem/rockFallApart.bmp", 5, &currentWorld->platformRefs[nextPlatformRef]->anim);
...
/* Special sound file to play when Monkey lands on platform, if any */
currentWorld->platformRefs[nextPlatformRef]->snd = loadSound("soundName");
...
/* Frame graphic */
currentWorld->frameGraphic = loadGraphic("frenziedFalls/frame.bmp");
...
/* Ambient sound effect loop */
currentWorld->ambientSnd = loadSound("AmbienceWaterFall.wav");


/* BACKGROUND LAYER 0: */
currentWorld->backgrounds[0] = loadGraphic("frenziedFalls/background.bmp");
currentWorld->scrollSpeeds[0] = 0;


/* BACKGROUND LAYER 4: */
currentWorld->backgrounds[4] = loadGraphic("frenziedFalls/cliff.bmp");
currentWorld->scrollSpeeds[4] = 5;


/* BACKGROUND LAYER 5: */
currentWorld->backgrounds[5] = loadGraphic("frenziedFalls/waterBack.bmp");
currentWorld->scrollSpeeds[5] = 8;


/* BACKGROUND LAYER 6: */
currentWorld->backgrounds[6] = loadGraphic("frenziedFalls/waterFront.bmp");
...
/* Frame graphic */
currentWorld->frameGraphic = loadGraphic("moltenMayhem/frame.bmp");
...
/* Ambient sound effect loop */
currentWorld->ambientSnd = loadSound("AmbienceVolcano.wav");


/* BACKGROUND LAYER 0: */
currentWorld->backgrounds[0] = loadGraphic("moltenMayhem/background.bmp");
currentWorld->scrollSpeeds[0] = 0;


/* BACKGROUND LAYER 2: */
currentWorld->backgrounds[2] = loadGraphic("moltenMayhem/distant.bmp");
currentWorld->scrollSpeeds[2] = 2;


/* BACKGROUND LAYER 4: */
currentWorld->backgrounds[4] = loadGraphic("moltenMayhem/middleRocks.bmp");
currentWorld->scrollSpeeds[4] = 4;


/* BACKGROUND LAYER 5: */
currentWorld->backgrounds[5] = loadGraphic("moltenMayhem/sides.bmp");
currentWorld->scrollSpeeds[5] = 5;
...
/* Load animation */
loadAnimation("moltenMayhem/hotRocks.bmp", 1, &currentWorld->platformRefs[nextPlatformRef]->anim);
...
/* Load animation */
loadAnimation("moltenMayhem/veryHotPlatform.bmp", 2, &currentWorld->platformRefs[nextPlatformRef]->anim);
...
/* Frame graphic */
currentWorld->frameGraphic = loadGraphic("skyScrapes/frame.bmp");
...
/* Ambient sound effect loop */
currentWorld->ambientSnd = loadSound("AmbienceRain.wav");


/* BACKGROUND LAYER 0: */
currentWorld->backgrounds[0] = loadGraphic("skyScrapes/background.bmp");
currentWorld->scrollSpeeds[0] = 0;


/* BACKGROUND LAYER 2: */
currentWorld->backgrounds[2] = loadGraphic("skyScrapes/pipesBack.bmp");
currentWorld->scrollSpeeds[2] = 2;


/* BACKGROUND LAYER 3: */
currentWorld->backgrounds[3] = loadGraphic("skyScrapes/pipesMid.bmp");
currentWorld->scrollSpeeds[3] = 3;


/* BACKGROUND LAYER 5: */
currentWorld->backgrounds[5] = loadGraphic("skyScrapes/pipesFore.bmp");
currentWorld->scrollSpeeds[5] = 5;


/* BACKGROUND LAYER 7: */
currentWorld->backgrounds[7] = loadGraphic("skyScrapes/rain.bmp");
